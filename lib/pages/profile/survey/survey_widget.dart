                      ...
                      onPressed: () async {
                        ...
                        await currentUserReference!.update({
                          ...createUsersRecordData(
                            ...
                            currentPhase: _model.phaseDeterminedInitial?.phase,
                            lastSurveyed: getCurrentTimestamp,
                            currentPhaseConfidence: valueOrDefault<double>(
                              _model.phaseDeterminedInitial?.confidence,
                              0.0,
                            ),
                          ),
                          ...mapToFirestore(
